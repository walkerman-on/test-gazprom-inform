...
export const Modal: FC<IModal> = ({ contentType, show, onCloseButtonClick }) => {
    ...
    return (
        <div className="flex absolute justify-center items-center top-0 right-0 bottom-0 left-0 z-10 size-full min-h-screen bg-gray-800 bg-opacity-60">
            <div className="relative bg-white w-1/2 h-1/2 rounded-xl overflow-hidden p-5">
